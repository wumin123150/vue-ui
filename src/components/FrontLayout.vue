    ...
    <footer class="footer">
      <div class="container">
        <div class="footer-main">
          <p class="footer-main-title">Element 1.4.2 Boron</p>
          <a href="#" target="_blank" class="footer-main-link">反馈建议</a>
          <a href="#" target="_blank" class="footer-main-link">贡献指南</a>
          <a href="#" target="_blank" class="footer-main-link">Element-React</a>
        </div>
        <div class="footer-social">
          <el-popover
            ...
            <i class="icon iconfont icon-wechat" slot="reference"></i>
          </el-popover>
          <a href="#" target="_blank"><i class="icon iconfont icon-mobilephone"></i></a>
        </div>
      </div>
    </footer>
  </div>
