<template>
  <aside>
    <div class="logo" :class="collapsed?'logo-collapse-width':'logo-width'">
      ...
      <span>{{collapsed?'':systemName}}</span>
    </div>
    <el-menu :default-active="$route.path" unique-opened :collapse="collapsed">
      <sidebar-item :routes='routes' class='menu-wrapper'></sidebar-item>
    </el-menu>
  </aside>
</template>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapGetters({ routes: 'routers', collapsed: 'sidebar' })
    }
  }
</script>
